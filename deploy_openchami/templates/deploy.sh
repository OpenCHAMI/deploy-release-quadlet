...
# Make sure the deployment directory tree is all owned by the
# deployment user when we start. It may have been created by or
# changed to 'root' by the python code.
